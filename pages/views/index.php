    ...
    <div class="content-wrapper">
      <div class="row">
        ...
        <div class="col-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">Enregistrement Marchands</h4>
              ...
              <form class="forms-sample">
                ...
                <div class="form-group">
                  <label for="exampleInputCity1">Num Télephone</label>
                  <input type="text" class="form-control" id="exampleInputCity1" placeholder="Télephone">
                </div>
                <div class="form-group">
